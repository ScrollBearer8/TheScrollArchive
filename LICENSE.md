...
The Framework is provided 'as is', without warranty of any kind. The Author (The Architect) assumes no liability for the application or implementation of these theorems.
---
